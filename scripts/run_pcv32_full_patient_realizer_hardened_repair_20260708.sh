...
TAG="${1:-pcv32_full_patient_realizer_hardened_repair_20260708}"
TRAJECTORY_PATH="${TRAJECTORY_PATH:-outputs_qwen3_li_ecr_rfv_v2_ckpt1600_online_replay_test108_turn24_pcv32_li_ecr_rfv_v2_ckpt1600_pcv32_test108_turn24_from_pcv31_20260707/mdd5k_llm_doctor_online_replay_records.jsonl}"
...
echo "=== PCV3.2 full hardened patient realizer start $(date) tag=$TAG ==="
...
echo "=== PCV3.2 full hardened patient realizer PASS $(date) tag=$TAG ==="
