...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Call Qwen3 HF model for constrained patient realizer requests.")
    ...
    parser.add_argument("--provider-tag", default="remote_qwen3_8b_hf_patient_realizer")
    parser.add_argument("--model-tag", default="Qwen3-8B-Patient-Realizer")
                    ...
                    json.dumps(
                        {
                            ...
                            "adapter": None if (args.no_adapter or not args.adapter_path) else str(args.adapter_path),
