...
from build_dynamic_patient_controller_v1 import contains_any, normalize_severity
from build_dynamic_patient_controller_v2 import (
    HIGH_SENSITIVITY_SLOTS,
    PRESSURE_CUES,
    doctor_recovery_quality,
    slot_sensitivity,
)
from build_dynamic_patient_controller_v3 import clamp, initial_disclosure_readiness, trait_for_profile
from build_dynamic_patient_controller_v3_1 import (
